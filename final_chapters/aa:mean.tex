...
\begin{proof}
  Let
  $g^\dagger$ is the function \eqref{ghost_function} with 
  $
(\lambda^\dagger,\lambda_0^\dagger)
  $.
  Let $N\ge\underline{N}$. If
  $
    \left| 
  ...
  by Lemma~\ref{fz_E0}
  and
  $f_z\perp D_N$ it follows from Lemma~\ref{w.Z=0}
  \begin{gather*}
    \E
    \left[
      w^\dagger(X)
  ...
  \begin{gather*}
    ...
    \,.
  \end{gather*}
  it follows from Lemma~\ref{lem_conv_G}
\begin{align*}
    \P
    \left[ 
      \sup_{z\in\R}
