...
\newpage
  ...
  german
  \end{center}
  In dieser Abschlussarbeit erweitere ich den Balacing Weights Ansatz von \cite{Wang2019} um die Verteilungsfunktion von Potential Outcomes zu schätzen.
  Ich schlage vor als Basis Funktionen die Basis nicht-parametrischer Partitioning Estimates zu wählen.
  Diese Wahl vereinfacht die Beweise deutlich und erlaubt es, die Methode mathematisch rigoros zu behandeln.
  Die asymptotische Analyse zeigt Konvergenz des Fehlers gegen einen Gaußschen Prozess.
  Meine Ergebnisse erlauben es direkt die Funktionale Delta-Methode auf Substitutions-Schätzer anzuwenden.
  Dies erschließt  der kausalen Inferenze in Beobachtungsstudien klassische Methoden der Statistik, wie Quantil-Schätzung, Hypothesen-Tests oder Überlebenszeit-Analyse.
  Die theoretischen Eigenschaften der von mir vorgeschlagenen Erweiterung sind vielversprechend - der Praxis-Test steht allerdings noch aus.
\tableofcontents 
