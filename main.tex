\documentclass[11pt, a4paper, BCOR=5mm, DIV=16, headinclude=true, footinclude=false]{scrbook}
\linespread{1.25}
...
\begin{center}
     ...
     %  \includegraphics[width=0.4\textwidth]{university}
       ...
       Supervised by PD Dr. Jürgen \textsc{Dippon}
       \\
       \textsc{
