...
\newpage
  ...
  by weighted means.
  I suggest a different perspective on covariate balance 
  by considering basis functions of non-parametric partitioning estimates.
  I carry out the asymptotic analysis that shows convergence of the error to a Gaussian process.
  My findings allow to apply the functional delta method to plug-in estimators and thereby makes classical statistical methods such as quantile estimation, hypothesis testing or survival analysis accessible to causal inference in observational studies.
