...
%\input{chapters/true_intro.tex}
%\chapter{Introduction}
 % \input{chapters/balancing_weights/intro_new.tex}
\chapter{The Optimization Problem behind the Weights}
\input{chapters/optimization_problem/main.tex}
\chapter{Pseudo Weights}
\input{chapters/pseudo_weights/main.tex}
\chapter{Consistency of the Weights}
\input{chapters/consistency_weights/main.tex}
%  \input{final_chapters/ebw:dual_formulation.tex}
  \newpage
%  \section{Dual Formulation}
%  \input{chapters/balancing_weights/dual_formulation.tex}
%  \newpage
...
%  \input{chapters/balancing_weights/consis_dual.tex}
%  \subsection*{Consistency of the Primal}
%  \input{chapters/balancing_weights/consis_primal.tex}
%  \subsection*{Consistency of the Weighted Mean}
%  \input{chapters/balancing_weights/consis_est.tex}
%
%  \chapter{Asymptotic Normality and Convergence to Gaussian Bridge}
%  \input{chapters/balancing_weights/an_intro.tex}
%  \subsection*{Learning Rates for the Dual}
%  \input{chapters/balancing_weights/an_dual.tex}
%  \subsection*{Learning Rates for the Primal}
%  \input{chapters/balancing_weights/an_primal.tex}
%  \subsection*{Asymptotic Normality of the Weighted Mean}
  ...
  %\input{chapters/balancing_weights/an.tex}
  %\input{chapters/balancing_weights/gaussian_bridge.tex}
  \section{Application to Plug In Estimators}
  \input{chapters/balancing_weights/plug_in_est.tex}
  %\input{chapters/balancing_weights/universal_consistency.tex}
  %\input{chapters/balancing_weights/universal_consistency.tex}
...
%  \input{chapters/balancing_weights/continuous_treatment.tex}
