...
In observational studie, the propensity score is unknown.
A very popular method is to use estimates of it to create weights.
We hope to recover \eqref{ipw} from the estimate.
In practice, estimating the propensity score is a difficult task.
Researchers often compare estimates from different models. 
