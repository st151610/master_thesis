...
\begin{proof}
  ...
  \todo[color=orange!40,inline]{Give proof Mordukhovich2022 p.256}
\end{proof}
...
\begin{proof}
  ...
  \todo[color=red!40,inline]{Provide proof. Mordukhovich2022 p.270}
\end{proof}
...
\begin{proof}
  ...
  yields the result.
\end{proof}
\todo[color=orange!40,inline]{Provide proof (Mordukhovich2022 p.293)}
\begin{theorem}
