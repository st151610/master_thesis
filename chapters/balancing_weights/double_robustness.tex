...
\begin{takeaways}
  Each decomposition gives us more information about the asymptotic properties of the weighted mean. Each case has consistency but may differ in speed of convergence. This is also a matter of technique. If both models hold we choose the faster rate of weights or regression. The true benefit to recover semiparametric efficiency from propensity score weighting with the true PS.
\end{takeaways}
