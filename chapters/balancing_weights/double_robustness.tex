...
\begin{assumptions*}
  \begin{enumerate}[label={(\roman*)}]
    \item
      There exists a function class $\mathcal{F}$ such that $f_0\in \mathcal{F}$ and
      $
      ...
      \begin{gather}
        \left\{ 
          \,
      \norm{\mathbb{G}_n}_{\,c\,\cdot B_{\mathcal{F}}\, \setminus\,  \left\{ f_0 \right\}}\ \le\  t 
      \,
        \right\}
        \ 
      \perp\!\!\!\perp 
      \ 
      \left\{ 
        \,f_0 \ \in\  c\cdot B_\mathcal{F}\,
      \right\}
      \end{gather}
      for all $t>0$ and all $c>0$.
  \end{enumerate}
\end{assumptions*}
