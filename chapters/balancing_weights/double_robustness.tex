...
The presence of confounders, especially when overlooked, is so aggravating that the statistical literature calls it paradoxical. Indeed, the term \textit{Simpson's paradox} bears to the issue of confounding (cf.\cite{Wagner1982} for a brief discussion of Simpson's paradox and some real world examples).
