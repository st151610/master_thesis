...
to address confounding in their investigations, the statistical literature coins the term 
...
Use non-probabilistic frameworks, such as causal framework.
Despite widespread acceptance, 
their use in empirical data analysis is still subject to debate~\cite[§6]{pearl2009causality}.
